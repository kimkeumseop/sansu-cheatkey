...
export const metadata: Metadata = {
  ...
  description:
    '목형산·화형산·토형산·금형산·수형산 — 산의 모양에 따라 달라지는 풍수 기운과, 내 사주에 맞는 산형을 고르는 방법을 정리했습니다.',
  ...
  return (
    <article className="p-6 pt-12">
      ...
      <div className="prose prose-sm max-w-none text-gray-700 leading-relaxed space-y-6">
        <p>
          전통 풍수지리에서는 산을 단순히 흙과 돌의 덩어리로 보지 않습니다. 산은 살아있는 거대한 에너지의 응집체이며, 그 형태에 따라 우주 만물을 구성하는 다섯 가지 원소인 &apos;오행(五行)&apos;의 기운을 내뿜는다고 믿었습니다. 이를 <strong className="text-gray-900">오성체(五星體)</strong>라고 합니다.
        </p>
        ...
        <p>
          ...
          풍수적으로는 <strong className="text-gray-900">&apos;공부, 학문, 문학, 예술&apos;</strong>의 기운을 상징합니다. 고시 공부를 하거나 창작 활동을 하는 분들에게 큰 영감을 주는 산입니다.
        </p>
        ...
        <p>
          ...
          화형산은 <strong className="text-gray-900">&apos;결단, 돌파, 변화&apos;</strong>를 의미합니다. 정체된 운세를 뚫고 싶거나, 강력한 추진력이 필요할 때 방문하면 화형산의 뜨거운 에너지가 큰 도움을 줍니다.
        </p>
        ...
        <p>
          ...
          토형산은 <strong className="text-gray-900">&apos;재물, 어머니, 안정&apos;</strong>을 상징합니다. 가정이 평안하기를 빌거나 사업의 기반을 튼튼히 다지고 싶을 때 토형산의 넉넉한 기운을 받는 것이 좋습니다.
        </p>
        ...
        <p>
          ...
          금형산은 <strong className="text-gray-900">&apos;명예, 귀인, 리더십&apos;</strong>을 의미합니다. 조직에서 승진을 원하거나 인생의 중요한 조력자를 만나고 싶을 때 추천하는 산형입니다.
        </p>

        <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4 border-l-4 border-blue-500 pl-3">5. 수형산(水形山) - 치유의 기운</h2>
        <p>
          마치 물결이 치는 것처럼 여러 봉우리가 완만하게 이어지는 산입니다. 
          수형산은 <strong className="text-gray-900">&apos;지혜, 인연, 정화&apos;</strong>의 에너지를 담고 있습니다. 인간관계로 상처받은 마음을 치유하거나, 새로운 인연을 만나고 싶을 때 수형산의 유연한 기운이 큰 힘이 됩니다.
        </p>
